...
const features = [
  { icon: Music, title: "Allsidig repertoar", desc: "Fra klassisk jazz og swing til funk, soul og moderne pop-arrangementer.", link: null },
  { icon: Users, title: "18 musikere", desc: "Et fullbemannet storband med erfarne musikere fra Vestfold-regionen.", link: "/medlemmer" },
  { icon: Star, title: "Lang fartstid", desc: "Stor track record med hundrevis av opptredener — og bred anerkjennelse for det vi leverer.", link: null },
];
          ...
          {features.map((f) => {
            ...
            return f.link ? (
              <button
                ...
                className="bg-card border border-border rounded-lg p-8 text-center hover:border-primary/40 transition-colors cursor-pointer"
              >
                {content}
              </button>
            ) : (
